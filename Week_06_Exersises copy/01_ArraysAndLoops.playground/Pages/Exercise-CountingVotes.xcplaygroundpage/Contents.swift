...
print ("There were \(yes) votes to change the Mascot.")
print ("There were \(no) votes against changing the Mascot.")
...
if yes > no {
    print("The mascot will be changed.")
} else {
    print("The mascot will stay the same.")
}
...
print ("There were \(yes) votes to install a coffee vending machine.")
print ("There were \(no) votes against installing a coffee vending machine.")

if yes > no {
    print("The vending machine will be installed.")
} else if no > yes {
    print("The vending machine will not be installed.")
} else {
    print("It's a tie. We must have a recount.")
}
...
print ("There were \(yes) votes to have more poll options.")
print ("There were \(no) votes against against having more poll options.")

if yes > no {
    print("Their will be more poll options made available.")
} else if no > yes {
    print("Their will not be more poll options made available.")
} else {
    print("It's a tie. We must have a recount.")
}
...
//: [Previous](@previous)  |  Exercise 2 of 4  |  [Next: Exercise: Goals](@next)
