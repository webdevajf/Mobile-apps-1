...
*/
var song = Song(title: "No, no, no", artist: "Fizz", duration: 150)
song.title
song.artist
song.duration
song.title = "Fizz and the Jets"
song.title
...
var song2 = Song(title: "Smokestack Ligtning", artist: "Howlin Wolf", duration: 232)

func songInfo(songGiven: Song){
    print("Title: " + songGiven.title)
    print("Artist: " + songGiven.artist)
    print("Duration: " + String(songGiven.duration))
}

songInfo(songGiven: song2)

//: Next, learn more about the properties of a struct.
//:
//: [Previous](@previous)  |  page 2 of 8  |  [Next: Struct Properties](@next)
